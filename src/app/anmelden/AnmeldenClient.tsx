...
// PROJ-9 Hotfix B-3 (Anmelden-Variante):
// Wie auf der Registrieren-Seite haben wir auch hier den next-Param
// auf eine Server-Component umgestellt, damit das hidden Input garantiert
// im SSR-HTML enthalten ist — auch bei Vercel-Edge-Cache-Hits.
...
export function AnmeldenClient({ initialEmail, initialNext, showExpiredLink }: Props) {
  const nextPath = initialNext || "/";
